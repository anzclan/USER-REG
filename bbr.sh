#!/bin/bash
echo -e "[INFO] Starting Install BBR Tweak"
...
echo -e "[INFO] BBR Instaled Successfully"
return 1
fi
echo -e "[INFO] Starting Install BBR Tweak"
modprobe tcp_bbr
...
Optimize_Parameters(){
echo -e "[INFO] BBR Optimize Parameters Successfully"
...
echo -e "[INFO] BBR Install Successfullly."
}
Install_BBR
Optimize_Parameters
